...
export const PREVIEW_COLUMNS = [
    ...
    { key: "stop_loss_value", label: "Stop Loss Value" },
    { key: "stop_loss_basis", label: "Stop Loss Basis" },
    { key: "cut_loss_value", label: "Cut Loss Value" },
    { key: "cut_loss_basis", label: "Cut Loss Basis" },
    { key: "cut_off_value", label: "Cut Off Value" },
    ...
    { key: "max_tenor_unit", label: "Max Tenor Unit" },
    { key: "max_sum_insured", label: "Max Sum Insured" },
    ...
    { key: "kolektibilitas_limit_amount", label: "Kolektibilitas Limit" },
];
